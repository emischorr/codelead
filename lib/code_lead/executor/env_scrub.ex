defmodule CodeLead.Executor.EnvScrub do
  ...
  @internal ~w(
    ...
    HOST_DATA_ROOT CONTAINER_USER DEVCONTAINER_CLI
    HARNESS_VERSION HARNESS_SOURCE
    PREVIEW_DOMAIN PREVIEW_PUBLISH_IP PREVIEW_UPSTREAM_HOST PREVIEW_RELAY_IMAGE
    PREVIEW_IDLE_MINUTES PREVIEW_START_TIMEOUT_SECONDS TERMINAL_IDLE_MINUTES
  )
