defmodule CodeLead.Accounts.User do
  @moduledoc """
  A person with a login. `role` gates instance administration; `locale` and
  `settings` back the profile page.
  """
  ...
  """
  def valid_password?(%CodeLead.Accounts.User{hashed_password: hashed_password}, password)
